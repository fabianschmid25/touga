...
class Story43V1Renderer implements FeedTemplateRenderer {
  @override
...
/// Story 4:3 V1 Design - Card-Layout mit sauberer Struktur:
...
class _Story43V1View extends StatefulWidget {
  final Article article;
  final String? authorName;
  final List<String>? categories;
  final String? authorAvatarUrl;

  const _Story43V1View({
    Key? key,
  ...
  @override
  State<_Story43V1View> createState() => _Story43V1ViewState();
}

class _Story43V1ViewState extends State<_Story43V1View>
